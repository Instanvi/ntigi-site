        ...
        <section className="py-16 border-b border-border-custom bg-primary/[0.01]">
          <div className="mx-auto max-w-7xl px-6 md:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 border-t border-l border-border-custom">
              {[
                { icon: Boat, title: "Ocean Freight Operators", desc: "Consolidate LCL shipments into full containers. Generate Bills of Lading and port manifests directly from NTIGI." },
                { icon: Buildings, title: "Warehouse Operators", desc: "Manage goods-in with barcode scanning, assign to consolidation batches by destination, and track every pallet from shelf to dispatch dock." },
                { icon: Truck, title: "Courier Consolidators", desc: "Bundle last-mile courier packages into route-based consolidations for dispatch vehicles. Reduce trips, increase delivery density per run." },
              ].map((item, i) => (
