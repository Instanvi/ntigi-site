  ...
  return (
    <div className="flex flex-col min-h-screen bg-background text-foreground transition-colors duration-300">
      ...
      <main className="flex-grow pt-16">
        ...
        {/* HERO â€” full-width background image (image2.jpg) with heavy overlay.
        ...
        <section className="relative py-24 border-b border-border-custom overflow-hidden noise-overlay">
          {/* background image â€” full bleed, overlaid */}
        ...
        {/* CAPABILITIES â€” icons only, no badge */}
        ...
        {/* PROOF SECTION â€” single full-width console frame above the detail cards.
        ...
        <section className="py-16 border-b border-border-custom">
          <div className="mx-auto max-w-7xl px-6 md:px-8">
            <AnimatedSection className="text-left mb-10 max-w-2xl">
              ...
              <p className="text-sm text-foreground/70 font-sans leading-relaxed font-medium mt-3">Stock levels, shelf locations, dispatch records â€” all visible in one screen per warehouse.</p>
            </AnimatedSection>
            ...
            >
              ...
              {/* screenshot â€” full width, taller aspect for this single wide frame */}
        ...
        {/* USE CASES â€” real photo card headers, no graphs, no badges
            image1 â†’ Transit Warehouse Operators
            image3 â†’ Bonded Warehouses
            ship.jpeg â†’ Freight Consolidators (port/container context) */}
        <section className="py-16 border-b border-border-custom bg-primary/[0.01]">
          <div className="mx-auto max-w-7xl px-6 md:px-8">
            <AnimatedSection className="text-left mb-10 max-w-2xl">
        ...
        {/* CTA â€” animated gradient only, no static grid */}
