...
const vehicleCapabilities = [
  {
    ...
    desc: "Register every vehicle in your fleet with type, capacity, license plate, registration number, and assigned branch. Full vehicle record accessible at any time.",
  },
  {
    icon: Gauge,
    title: "Capacity Tracking",
    desc: "Track the load capacity of each vehicle by weight and volume. Prevent over-loading by monitoring what is assigned versus what the vehicle can carry on each run.",
  },
  {
    icon: Wrench,
    title: "Maintenance Scheduling",
    desc: "Schedule and track vehicle maintenance by mileage or date. Receive alerts before service is due. Keep a complete maintenance history per vehicle.",
  },
  {
    icon: GasPump,
    title: "Fuel Tracking",
    desc: "Log fuel fill-ups per vehicle and track fuel costs over time. Monitor fuel consumption per route to identify inefficiencies and reduce operating costs.",
  },
  {
    icon: MapPin,
    title: "GPS Tracking Integration",
    desc: "Track every vehicle's live location on an interactive map. Managers see the full fleet in real time. Customers see their shipment moving toward them.",
  },
  {
    icon: ChartLine,
    title: "Performance Metrics",
    desc: "Monitor delivery success rates, on-time percentages, distance covered, and fuel efficiency per vehicle. Compare fleet performance across routes and periods.",
  },
];
...
const driverCapabilities = [
  {
    ...
    desc: "Create detailed profiles for every driver with contact information, assigned branch, active routes, and current delivery status.",
  },
  {
    icon: IdentificationCard,
    title: "License Tracking",
    desc: "Record driver license numbers, license categories, issue dates, and expiry dates. Receive alerts when a license is approaching expiry.",
  },
  {
    icon: ClipboardText,
    title: "Route Assignment",
    desc: "Assign drivers to specific routes or delivery runs. Drivers see their assigned shipments in the mobile app and can manage their queue throughout the day.",
  },
  {
    icon: ChartLine,
    title: "Performance Tracking",
    desc: "Track deliveries completed, success rates, average delivery times, and customer confirmation rates per driver. Identify top performers and underperformers.",
  },
  {
    icon: DeviceMobile,
    title: "Mobile App for Drivers",
    desc: "Drivers use NTIGI's mobile PWA on any smartphone. View delivery queue, navigate to stops, scan barcodes, capture signatures and photos. Works offline.",
  },
  {
    icon: ShieldCheck,
    title: "POD Capture",
    desc: "Drivers capture proof of delivery directly from their phone: recipient signature, photo of the package, and GPS location. All attached to the shipment record instantly.",
  },
];
...
const workflow = [
  {
    ...
    desc: "Add the vehicle with type, capacity, registration details, and assigned branch. The vehicle is immediately available for route and driver assignment.",
  },
  {
    step: "02",
    title: "Create Driver Profile",
    desc: "Add the driver with license details and branch assignment. Link the driver to their vehicle. Set their initial role and permissions in the NTIGI mobile app.",
  },
  {
    step: "03",
    title: "Assign to Route",
    desc: "Assign the driver and vehicle to a delivery route or specific run. Shipments appear in the driver's queue on their mobile app immediately.",
  },
  {
    step: "04",
    title: "Track in Real Time",
    desc: "The vehicle GPS location updates live on the fleet map. Managers see every vehicle. Customers see their shipment status update as the driver progresses.",
  },
  {
    step: "05",
    title: "Review Performance",
    desc: "After the run, review delivery success rates, fuel usage, and on-time performance per driver and vehicle. Schedule any required maintenance from the same dashboard.",
  },
];
...
const stats = [
  { value: "Real-Time", label: "GPS fleet tracking" },
  { value: "Full", label: "Maintenance history" },
  { value: "Mobile", label: "PWA driver app" },
  { value: "100%", label: "POD evidence capture" },
];
      ...
      <main className="flex-grow pt-16">
          ...
          <div className="mx-auto max-w-7xl px-6 md:px-8">
            <div className="text-left mb-12 max-w-2xl">
              ...
              <p className="text-sm text-foreground/70 font-sans leading-relaxed font-medium mt-3">
                Every vehicle in your operation registered, tracked, maintained, and reported from a single platform.
              </p>
            </div>
        ...
        <section className="py-16 border-b border-border-custom bg-primary/[0.01]">
          <div className="mx-auto max-w-7xl px-6 md:px-8">
            <div className="text-left mb-12 max-w-2xl">
              <h2 className="text-2xl font-bold font-sans uppercase tracking-tight">
                Full Driver Lifecycle Tracking
              </h2>
              <p className="text-sm text-foreground/70 font-sans leading-relaxed font-medium mt-3">
                From onboarding to daily performance: every driver record, license, route, and delivery outcome managed in one place.
              </p>
            </div>
        ...
        <section className="py-16 border-b border-border-custom">
          <div className="mx-auto max-w-7xl px-6 md:px-8">
            <div className="text-left mb-12 max-w-2xl">
              ...
              <p className="text-sm text-foreground/70 font-sans leading-relaxed font-medium mt-3">
                A clear five-step process for onboarding a new vehicle or driver and getting them operational on the first day.
              </p>
            </div>
        ...
        {/* Vehicle + Driver Records - 2 column */}
        <section className="py-16 border-b border-border-custom bg-primary/[0.01]">
          <div className="mx-auto max-w-7xl px-6 md:px-8 grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-[var(--console-bg)] border border-border-custom rounded-none p-6 space-y-4">
              ...
              <p className="text-sm text-foreground/70 font-sans leading-relaxed font-medium">
                Each vehicle has a complete operational record. Every detail needed to dispatch, maintain, and report on that vehicle is in one place.
              </p>
            ...
            {/* Driver Record + Maintenance Alerts */}
            <div className="space-y-6">
              <div className="bg-[var(--console-bg)] border border-border-custom rounded-none p-6 space-y-4">
                ...
                <p className="text-sm text-foreground/70 font-sans leading-relaxed font-medium">
                  Complete driver records from personal details and license compliance through to daily performance and delivery history.
                </p>
              ...
              <div className="bg-[var(--console-bg)] border border-border-custom rounded-none p-6 space-y-4">
                ...
                <p className="text-sm text-foreground/70 font-sans leading-relaxed font-medium">
                  NTIGI watches your fleet and driver compliance automatically. These alerts trigger before problems occur, not after.
                </p>
                <div className="space-y-2 pt-1">
          ...
          <div className="mx-auto max-w-7xl px-6 md:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 border-t border-l border-border-custom">
              <div className="p-6 border-r border-b border-border-custom space-y-3 hover:bg-primary/[0.04] transition-all">
                ...
                <p className="text-sm text-foreground/70 font-sans leading-relaxed font-medium">
                  Manage 10 to 100 drivers daily. Track every vehicle on a live map, assign shipments to drivers automatically, and review delivery performance at the end of each day.
                </p>
              </div>
              ...
              <div className="p-6 border-r border-b border-border-custom space-y-3 hover:bg-primary/[0.04] transition-all">
                ...
                <p className="text-sm text-foreground/70 font-sans leading-relaxed font-medium">
                  Track heavy vehicles on long inter-city routes. Monitor fuel consumption per trip, schedule servicing by mileage, and ensure license compliance for all commercial drivers.
                </p>
              </div>
              ...
              <div className="p-6 border-r border-b border-border-custom space-y-3 hover:bg-primary/[0.04] transition-all">
                ...
                <p className="text-sm text-foreground/70 font-sans leading-relaxed font-medium">
                  Each branch manages its own fleet independently while head office sees network-wide performance. Compare vehicle utilization and driver productivity across all locations.
                </p>
              </div>
            </div>
          </div>
              ...
              {[
                {
                  ...
                  desc: "Assign your registered vehicles and drivers to optimized routes with distance calculation, transit times, and real-time tracking.",
                  href: "/solutions/route-optimization",
                },
                {
                  title: "Proof of Delivery",
                  desc: "Your drivers capture signatures, photos, and GPS confirmation at every stop using the same NTIGI mobile app.",
                  href: "/solutions/proof-of-delivery",
                },
                {
                  title: "Multi-Branch Network",
                  desc: "Manage fleets across multiple branches with branch-level data isolation and consolidated head-office reporting.",
          ...
          <div className="mx-auto max-w-7xl px-6 md:px-8 relative z-10">
            <div className="max-w-2xl space-y-4">
              <h2 className="text-2xl md:text-3xl font-extrabold uppercase font-sans tracking-tight leading-none">
                ...
                <br />
                <span className="text-blue-500">of Your Fleet?</span>
              </h2>
              <p className="text-sm text-foreground/70 font-sans leading-relaxed font-medium">
                See how NTIGI manages your vehicles, drivers, and delivery performance in a live walkthrough with our team.
              </p>
              <div className="flex flex-wrap gap-3 pt-2">
                <Button variant="primary" href="/demo" size="lg">
                  Request a Demo
