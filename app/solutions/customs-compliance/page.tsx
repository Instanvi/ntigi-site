        ...
        <section className="relative py-20 bg-[var(--console-header)] border-b border-border-custom overflow-hidden noise-overlay">
          <div className="mx-auto max-w-7xl px-6 md:px-8 relative z-10">
            <AnimatedSection className="max-w-3xl space-y-4">
              <div className="inline-block px-3 py-1 bg-primary/10 border border-blue-500/30 text-blue-500 rounded-none text-xs font-bold uppercase tracking-wider">For Customs Brokers & Freight Forwarders</div>
        ...
        <section className="py-16 border-b border-border-custom bg-primary/[0.01]">
          <div className="mx-auto max-w-7xl px-6 md:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 border-t border-l border-border-custom">
              {[
                { icon: Buildings, title: "Customs Brokers", desc: "Handle multiple client accounts with document generation, HS code lookup, and duty calculation built in. Reduce manual paperwork and clearance time." },
                { icon: Globe, title: "Freight Forwarders", desc: "Embed compliance directly into your international forwarding workflow. Documents are generated at the point of booking, not as an afterthought." },
                { icon: ChartLine, title: "Compliance Teams", desc: "Full audit trail, exportable compliance logs, and screening records for every shipment. Built-in GDPR tools and configurable data retention policies." },
              ].map((item, i) => (
          ...
          <div className="mx-auto max-w-7xl px-6 md:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 border-t border-l border-border-custom">
              {[
                ...
                { title: "Finance & Billing", desc: "Issue multi-currency invoices with duties and taxes automatically calculated per jurisdiction.", href: "/solutions/finance" },
              ].map((sol, i) => (
