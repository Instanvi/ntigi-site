...
import {
  ...
  ArrowsClockwise, UsersThree, Buildings,
    ...
    <div className="flex flex-col min-h-screen bg-background text-foreground transition-colors duration-300">
      ...
      <main className="flex-grow pt-16">
        ...
        <section className="relative py-20 bg-[var(--console-header)] border-b border-border-custom overflow-hidden noise-overlay">
          <div className="mx-auto max-w-7xl px-6 md:px-8 relative z-10">
            <AnimatedSection className="max-w-3xl space-y-4">
              <div className="inline-block px-3 py-1 bg-primary/10 border border-blue-500/30 text-blue-500 rounded-none text-xs font-bold uppercase tracking-wider">For Couriers and Freight Networks</div>
          ...
          <div className="mx-auto max-w-7xl px-6 md:px-8 grid md:grid-cols-2 gap-8">
            ...
            <AnimatedSection direction="right" className="space-y-6">
              ...
              <div className="bg-[var(--console-bg)] border border-border-custom rounded-none p-6 space-y-3">
                ...
                <p className="text-sm text-foreground/70 font-sans leading-relaxed font-medium">Route data syncs to the desktop and mobile apps during connectivity and remains available offline. Agents can book shipments on any route without an internet connection. Reference data syncs automatically in the background every 5 minutes.</p>
        ...
        <section className="py-16 border-b border-border-custom bg-primary/[0.01]">
          <div className="mx-auto max-w-7xl px-6 md:px-8">
            <AnimatedSection className="text-left mb-12 max-w-2xl">
              <div className="inline-block px-3 py-1 bg-primary/10 border border-blue-500/30 text-blue-500 rounded-none text-xs font-bold uppercase tracking-wider mb-3">Pricing Engine</div>
        ...
        <section className="py-16 border-b border-border-custom">
          <div className="mx-auto max-w-7xl px-6 md:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 border-t border-l border-border-custom">
              {[
                { icon: Truck, title: "City Courier Networks", desc: "Define inner-city delivery zones with cluster mapping, assign drivers to zone routes, and track every vehicle on a live map throughout the delivery day." },
                { icon: Buildings, title: "Inter-City Freight Lines", desc: "Create multi-leg routes spanning cities and borders with stop-by-stop transit times. Price each corridor separately and report on performance per line." },
                { icon: UsersThree, title: "Agency Networks", desc: "Assign partner agencies to specific route segments. Each agency handles their leg with full visibility into what is arriving, when, and what it should cost." },
              ].map((item, i) => (
