...
import {
  ...
  ClipboardText, ChartLine, Truck, Buildings, Stack,
        ...
        <section className="relative py-20 bg-[var(--console-header)] border-b border-border-custom overflow-hidden noise-overlay">
          <div className="mx-auto max-w-7xl px-6 md:px-8 relative z-10">
            <AnimatedSection className="max-w-3xl space-y-4">
              <div className="inline-block px-3 py-1 bg-primary/10 border border-blue-500/30 text-blue-500 rounded-none text-xs font-bold uppercase tracking-wider">For Warehouse Operators and Logistics Teams</div>
          ...
          <div className="mx-auto max-w-7xl px-6 md:px-8 grid md:grid-cols-2 gap-8">
            ...
            <AnimatedSection direction="right" className="space-y-6">
              ...
              <div className="bg-[var(--console-bg)] border border-border-custom rounded-none p-6 space-y-3">
                ...
                <p className="text-sm text-foreground/70 font-sans leading-relaxed font-medium">Warehouse staff use the NTIGI mobile PWA to scan barcodes, receive goods, and update stock anywhere in the building, including dead zones with no signal. All actions queue and sync when connectivity returns. Zero lost receiving records.</p>
        ...
        <section className="py-16 border-b border-border-custom bg-primary/[0.01]">
          <div className="mx-auto max-w-7xl px-6 md:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 border-t border-l border-border-custom">
              {[
                { icon: Buildings, title: "Multi-Warehouse Operators", desc: "Manage stock across multiple warehouse locations from one dashboard. Each warehouse has independent bin maps and stock levels. Head office sees everything." },
                { icon: Truck, title: "Transit Hubs", desc: "High-volume receiving with barcode scanning at the dock. Sort incoming goods by destination, assign to consolidation batches, and track dwell time for every package." },
                { icon: ChartLine, title: "Operations Managers", desc: "Real-time visibility over stock levels, capacity utilization, and movement history without needing to walk the warehouse floor. Export reports for stakeholders on demand." },
              ].map((item, i) => (
