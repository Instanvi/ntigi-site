        ...
        <section className="py-16 border-b border-border-custom bg-primary/[0.01]">
          <div className="mx-auto max-w-7xl px-6 md:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 border-t border-l border-border-custom">
              {[
                { img: "/payment.jpg", icon: ShoppingBag, title: "E-commerce Businesses", desc: "Give your online shoppers the tracking experience they expect. Real-time notifications, delivery photos, and a clean tracking page branded to your logistics operation." },
                { img: "/payshipment.jpg", icon: UsersThree, title: "Frequent Business Shippers", desc: "Business clients who ship daily can manage their own bookings, monitor outstanding balances, and download invoices for accounting without needing your staff." },
                { img: "/ship.jpeg", icon: ArrowsCounterClockwise, title: "Returns Management", desc: "Customers submit return shipment requests through the portal. Your team reviews and approves. The return is created, tracked, and invoiced automatically." },
              ].map((item, i) => (
