  ...
  const offices = [
    {
      ...
      hours: "Mon to Fri: 8:00 AM to 5:00 PM (GMT+1)",
    },
    {
      city: "London",
      ...
      hours: "Mon to Fri: 9:00 AM to 6:00 PM (GMT)",
    },
    {
      city: "Chicago",
      ...
      email: "chicago@ntigi.com",
      hours: "Mon to Fri: 9:00 AM to 5:00 PM (CST)",
    },
  ];
  ...
  const contactReasons = [
    {
      ...
      desc: "Get a custom pricing proposal based on your operation size, branch count, and shipment volume.",
    },
    {
      icon: Wrench,
      title: "Technical Support",
      desc: "Support for setup, configuration, integrations, and troubleshooting across all NTIGI platforms.",
    },
    {
      icon: Users,
      title: "Partnerships",
      desc: "Discuss agency network partnerships, integration partnerships, or reseller agreements.",
    },
    {
      icon: ChatCircle,
      title: "General Enquiries",
      desc: "Questions about NTIGI's capabilities, deployment options, or team training programs.",
    },
  ];
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background text-foreground transition-colors duration-300">
      ...
      <main className="flex-grow pt-16">
          ...
          <div className="mx-auto max-w-7xl px-6 md:px-8 relative z-10">
            <div className="max-w-3xl space-y-4">
              ...
              <h1 className="text-3xl md:text-5xl font-extrabold uppercase font-sans tracking-tight leading-none">
                Get in Touch
                <br />
                <span className="text-blue-500">with Our Team</span>
              </h1>
          ...
          <div className="mx-auto max-w-7xl px-6 md:px-8">
            <div className="grid grid-cols-2 md:grid-cols-4 border-l border-border-custom">
              {contactReasons.map((item, i) => (
                <div key={i} className="p-6 border-r border-b md:border-b-0 border-border-custom hover:bg-primary/[0.04] transition-all space-y-2">
          ...
          <div className="mx-auto max-w-7xl px-6 md:px-8 grid md:grid-cols-12 gap-8">
            ...
            <div className="md:col-span-7 space-y-6">
              <div>
                ...
                <p className="text-sm text-foreground/70 font-sans font-medium leading-relaxed mt-2">
                  Three offices across Africa, Europe, and North America, covering all major logistics trade lanes.
                </p>
              </div>
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div className="flex items-start gap-2.5">
                        ...
                        <span className="text-sm text-foreground/75 font-sans font-medium">{office.address}</span>
                      </div>
                      <div className="flex items-start gap-2.5">
                        <Phone className="w-4 h-4 text-blue-500 flex-shrink-0 mt-0.5" />
                        <a
                          href={`tel:${office.phone.replace(/\s+/g, "")}`}
                          className="text-sm text-foreground/75 font-sans font-medium hover:text-blue-500 transition-colors"
                        >
                          {office.phone}
                        </a>
                      </div>
                      ...
                      <div className="flex items-start gap-2.5">
                        ...
                        <span className="text-sm text-foreground/75 font-sans font-medium">{office.hours}</span>
                      </div>
                    </div>
                  </div>
                ))}
              ...
              <div className="bg-[var(--console-bg)] rounded-none p-6 border border-border-custom space-y-5">
                ...
                {status === "success" ? (
                  <div className="text-center py-10 space-y-4">
                    ...
                    <p className="text-sm text-foreground/70 font-sans font-medium leading-relaxed">
                      Your message has been received. An NTIGI team member will respond within one business day.
                    </p>
                  ...
                  <form className="space-y-4" onSubmit={handleSubmit}>
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 bg-background border border-border-custom rounded-none text-foreground text-sm focus:outline-none focus:border-blue-500 transition-colors"
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={handleChange}
                        className="w-full px-4 py-3 bg-background border border-border-custom rounded-none text-foreground text-sm focus:outline-none focus:border-blue-500 transition-colors h-28 resize-none"
                        placeholder="Describe your branch size, requirements, or question..."
                        required
                      />
                    </div>
                    <Button
        ...
        {/* Bottom CTA strip */}
        <section className="py-16 bg-[var(--console-header)] border-b border-border-custom relative overflow-hidden">
          <div className="mx-auto max-w-7xl px-6 md:px-8 relative z-10">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div className="space-y-2">
                <h2 className="text-2xl font-extrabold uppercase font-sans tracking-tight leading-none">
                  Prefer to See It First?
                </h2>
                <p className="text-sm text-foreground/70 font-sans font-medium">
                  Book a live demo and our team will walk you through NTIGI for your specific operation.
                </p>
              </div>
