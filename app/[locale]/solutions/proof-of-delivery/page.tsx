...
const podFeedLinesA: FeedLine[] = [
  { status: "ASSIGNED", msg: "PKG-2847 â†’ Driver Kofi Mensah", color: "text-blue-400", delayAfter: 250 },
  { status: "ASSIGNED", msg: "PKG-2912 â†’ Driver Ama Etta", color: "text-blue-400", delayAfter: 350 },
  { status: "ASSIGNED", msg: "PKG-3101 â†’ Driver Sarah Ntone", color: "text-blue-400", delayAfter: 400 },
  ...
  { status: "IN_TRANSIT", msg: "PKG-2847 GPS: 5.6037Â°N, 0.1870Â°W enroute", color: "text-foreground/50", delayAfter: 4200 },
  { status: "IN_TRANSIT", msg: "PKG-3101 GPS: 5.6500Â°N, 0.2000Â°W enroute", color: "text-foreground/50", delayAfter: 3100 },
...
const podFeedLinesB: FeedLine[] = [
  { status: "ASSIGNED", msg: "PKG-4021 â†’ Driver Chioma Okafor", color: "text-blue-400", delayAfter: 200 },
  { status: "ASSIGNED", msg: "PKG-4156 â†’ Driver John Smith", color: "text-blue-400", delayAfter: 300 },
  { status: "ASSIGNED", msg: "PKG-4288 â†’ Driver Che Ntone", color: "text-blue-400", delayAfter: 450 },
  ...
  { status: "IN_TRANSIT", msg: "PKG-4021 GPS: 6.5244Â°N, 3.3792Â°E enroute", color: "text-foreground/50", delayAfter: 4500 },
  { status: "IN_TRANSIT", msg: "PKG-4156 GPS: 6.5100Â°N, 3.3500Â°E enroute", color: "text-foreground/50", delayAfter: 3300 },
