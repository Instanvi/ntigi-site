...
const apiLines = [
  ...
  { delay: 320,  color: "text-green-400",     text: 'â†’ 201 Created  { id: "SHP-29471" }' },
  { delay: 640,  color: "text-foreground/40", text: "POST /api/v1/shipments" },
  { delay: 960,  color: "text-green-400",     text: 'â†’ 201 Created  { id: "SHP-29472" }' },
  { delay: 1280, color: "text-blue-400",      text: "GET  /api/v1/shipments/SHP-29471/label" },
  { delay: 1600, color: "text-green-400",     text: "â†’ 200 OK  label.pdf  [barcode attached]" },
  { delay: 1920, color: "text-yellow-400",    text: "WEBHOOK â†’ order.shipped { tracking: true }" },
  { delay: 2240, color: "text-foreground/40", text: "GET  /api/v1/shipments?status=in_transit" },
  { delay: 2560, color: "text-green-400",     text: "â†’ 200 OK  [ 847 shipments ]" },
  { delay: 2880, color: "text-blue-400",      text: "POST /api/v1/notifications/bulk" },
  { delay: 3200, color: "text-green-400",     text: "â†’ 200 OK  sent: 847  failed: 0" },
];
