...
/* â”€â”€ Feed data with realistic delays (ms) between lines â”€â”€ */
interface FeedLine {
  code: string;
  event: string;
  detail: string;
...
const scanFeedLinesA: FeedLine[] = [
  { code: "NTG-84721", event: "RECEIVED", detail: "Bin: A-03-12 Â· 4.2kg Â· Staff: Kofi Mensah", color: "text-green-400", delayAfter: 220 },
  { code: "NTG-84722", event: "RECEIVED", detail: "Bin: A-03-13 Â· 1.8kg Â· Staff: Ama Etta", color: "text-green-400", delayAfter: 380 },
  { code: "NTG-84719", event: "MOVED", detail: "A-01-07 â†’ B-02-04 Â· Staff: Peter Njoh", color: "text-yellow-400", delayAfter: 1800 },
  ...
  { code: "NTG-84590", event: "DISPATCHED", detail: "Route: ACC â†’ LOS Â· Driver: Che Ntone", color: "text-foreground/40", delayAfter: 4200 },
  { code: "NTG-84723", event: "RECEIVED", detail: "Bin: C-01-02 Â· 12.0kg Â· FRAGILE Â· Staff: Sarah Ntone", color: "text-green-400", delayAfter: 3100 },
  { code: "NTG-84510", event: "DISPATCHED", detail: "Route: ACC â†’ ABJ Â· Driver: Nji Che", color: "text-foreground/40", delayAfter: 2800 },
  { code: "NTG-84724", event: "RECEIVED", detail: "Bin: D-02-05 Â· 8.5kg Â· Staff: Paul Nji", color: "text-green-400", delayAfter: 1900 },
  { code: "NTG-84721", event: "MOVED", detail: "A-03-12 â†’ B-01-01 Â· Staff: James Jones", color: "text-yellow-400", delayAfter: 1400 },
  { code: "NTG-84725", event: "RESERVED", detail: "Consol batch C-2848", color: "text-blue-400", delayAfter: 500 },
  { code: "NTG-84600", event: "DISPATCHED", detail: "Route: ACC â†’ KUM Â· Driver: Chioma Okafor", color: "text-foreground/40", delayAfter: 3800 },
  { code: "NTG-84726", event: "RECEIVED", detail: "Bin: A-04-08 Â· 22.0kg Â· Staff: Thomas Mueller", color: "text-green-400", delayAfter: 2500 },
  { code: "NTG-84599", event: "FOUND", detail: "Lost parcel recovered at Gate B Â· Staff: Anna Schmidt", color: "text-green-400", delayAfter: 900 },
  { code: "NTG-84601", event: "DISPATCHED", detail: "Route: ACC â†’ TAM Â· Driver: Fatou Ndiaye", color: "text-foreground/40", delayAfter: 3600 },
  { code: "NTG-84727", event: "AUDIT", detail: "Cycle count complete 0 discrepancies Â· Staff: Kwame Asante", color: "text-blue-400", delayAfter: 1200 },
];

/* Feed B: Lagos hub, afternoon shift */
const scanFeedLinesB: FeedLine[] = [
  { code: "NTG-92001", event: "RECEIVED", detail: "Bin: L-01-03 Â· 3.1kg Â· Staff: John Smith", color: "text-green-400", delayAfter: 250 },
  { code: "NTG-92002", event: "RECEIVED", detail: "Bin: L-01-04 Â· 5.7kg Â· Staff: Amadou Diallo", color: "text-green-400", delayAfter: 400 },
  { code: "NTG-91900", event: "MOVED", detail: "L-02-01 â†’ L-03-08 Â· Staff: Maria Schmidt", color: "text-yellow-400", delayAfter: 1700 },
  { code: "NTG-91850", event: "RESERVED", detail: "Consol batch L-1047", color: "text-blue-400", delayAfter: 700 },
  { code: "NTG-92003", event: "RECEIVED", detail: "Bin: L-02-02 Â· 1.2kg Â· FRAGILE Â· Staff: Pierre Dubois", color: "text-green-400", delayAfter: 2200 },
  { code: "NTG-91800", event: "DISPATCHED", detail: "Route: LOS â†’ ACC Â· Driver: Jean Njoh", color: "text-foreground/40", delayAfter: 4500 },
  { code: "NTG-92004", event: "RECEIVED", detail: "Bin: L-03-01 Â· 9.8kg Â· Staff: Robert Jones", color: "text-green-400", delayAfter: 1800 },
  { code: "NTG-92001", event: "MOVED", detail: "L-01-03 â†’ L-04-04 Â· Staff: Linda Etta", color: "text-yellow-400", delayAfter: 1300 },
  { code: "NTG-92005", event: "RESERVED", detail: "Consol batch L-1048", color: "text-blue-400", delayAfter: 500 },
  { code: "NTG-91801", event: "DISPATCHED", detail: "Route: LOS â†’ ABJ Â· Driver: Samuel Che", color: "text-foreground/40", delayAfter: 3900 },
  { code: "NTG-92006", event: "RECEIVED", detail: "Bin: L-05-02 Â· 14.5kg Â· HAZARDOUS Â· Staff: Etta Ntone", color: "text-green-400", delayAfter: 2800 },
  { code: "NTG-91750", event: "FOUND", detail: "Misplaced item located at Dock 3 Â· Staff: Nji Che", color: "text-green-400", delayAfter: 1100 },
  { code: "NTG-91802", event: "DISPATCHED", detail: "Route: LOS â†’ KAN Â· Driver: James Jones", color: "text-foreground/40", delayAfter: 4100 },
  { code: "NTG-92007", event: "RECEIVED", detail: "Bin: L-06-01 Â· 2.4kg Â· Staff: Ama Ntone", color: "text-green-400", delayAfter: 2000 },
  { code: "NTG-92008", event: "AUDIT", detail: "Weight mismatch resolved 4.2kg corrected Â· Staff: Peter Njoh", color: "text-blue-400", delayAfter: 800 },
  { code: "NTG-91803", event: "DISPATCHED", detail: "Route: LOS â†’ ONI Â· Driver: Chioma Okafor", color: "text-foreground/40", delayAfter: 3400 },
];
    ...
    >
      ...
      <div className="flex-1 p-4 font-mono text-[10px] leading-3 space-y-1.5 overflow-hidden">
        <div className="text-foreground/30 mb-2 text-[9px] tracking-widest">
          WAREHOUSE: {cycle % 2 === 0 ? "ACCRA-01" : "LAGOS-HUB"} Â· ZONE: RECEIVING
        </div>
        {feed.map((line, i) => (
          <motion.div
            key={`${cycle}-${i}`}
