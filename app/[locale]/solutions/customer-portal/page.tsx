...
import {
  ...
  ChartLine, Globe, ShoppingBag, UsersThree, Terminal
...
export default function CustomerPortal() {
  const t = useTranslations("Solutions.customer-portal");

  const capabilities = [
    { icon: Package, title: t("capabilities.0.title"), desc: t("capabilities.0.desc") },
    { icon: MapPin, title: t("capabilities.1.title"), desc: t("capabilities.1.desc") },
    { icon: Receipt, title: t("capabilities.2.title"), desc: t("capabilities.2.desc") },
    { icon: CurrencyDollar, title: t("capabilities.3.title"), desc: t("capabilities.3.desc") },
    { icon: User, title: t("capabilities.4.title"), desc: t("capabilities.4.desc") },
    { icon: Bell, title: t("capabilities.5.title"), desc: t("capabilities.5.desc") },
    { icon: MagnifyingGlass, title: t("capabilities.6.title"), desc: t("capabilities.6.desc") },
    { icon: DeviceMobile, title: t("capabilities.7.title"), desc: t("capabilities.7.desc") },
  ];
  ...
  const customerFeatures = [
    { label: t("customerFeatures.0.label"), desc: t("customerFeatures.0.desc") },
    { label: t("customerFeatures.1.label"), desc: t("customerFeatures.1.desc") },
    { label: t("customerFeatures.2.label"), desc: t("customerFeatures.2.desc") },
    { label: t("customerFeatures.3.label"), desc: t("customerFeatures.3.desc") },
    { label: t("customerFeatures.4.label"), desc: t("customerFeatures.4.desc") },
    { label: t("customerFeatures.5.label"), desc: t("customerFeatures.5.desc") },
    { label: t("customerFeatures.6.label"), desc: t("customerFeatures.6.desc") },
    { label: t("customerFeatures.7.label"), desc: t("customerFeatures.7.desc") },
  ];

  const notificationTypes = [
    t("notificationTypes.0"),
    t("notificationTypes.1"),
    t("notificationTypes.2"),
    t("notificationTypes.3"),
    t("notificationTypes.4"),
    t("notificationTypes.5"),
    t("notificationTypes.6"),
    t("notificationTypes.7"),
  ];
      ...
      <main className="flex-grow pt-16">
        ...
        <section className="relative min-h-[500px] border-b border-border-custom overflow-hidden noise-overlay flex items-stretch">
          ...
          <div className="hidden md:block absolute top-0 right-0 bottom-0 w-1/2 z-0">
            <Image
              src="/portview.jpg"
              alt="NTIGI customer self-service portal dashboard view"
              fill
        ...
        <section className="py-16 border-b border-border-custom bg-primary/[0.01]">
          <div className="mx-auto max-w-7xl px-6 md:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 border-t border-l border-border-custom">
              {[
                { img: "/payment.jpg", icon: ShoppingBag, title: t("jsx.h4_0"), desc: t("jsx.p_6") },
                { img: "/payshipment.jpg", icon: UsersThree, title: t("jsx.h4_1"), desc: t("jsx.p_7") },
                { img: "/ship.jpeg", icon: ArrowsCounterClockwise, title: t("jsx.h4_2"), desc: t("jsx.p_8") },
              ].map((item, i) => (
        ...
        <section className="py-16 border-b border-border-custom">
          <div className="mx-auto max-w-7xl px-6 md:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 border-t border-l border-border-custom">
              {[
                { title: t("jsx.related_title_0"), desc: t("jsx.related_desc_0"), href: "/solutions/proof-of-delivery" },
